  ...
  theme: {
    extend: {
      ...
      backgroundIage: {
        ...
        "grid-01": "url(../img/bg_gridBox_1.png)",
        "grid-02": "url(../img/bg_gridBox_2.png)",
        "grid-03": "url(../img/bg_gridBox_3.png)",
        "grid-04": "url(../img/bg_gridBox_4.png)",
        "grid-05": "url(../img/bg_gridBox_5.png)",
        ...
        "news-section-bg": "url(../img/bg_news.png)",
        "news-section-bg": "url(../img/bg_news_m.png)",
      },
    },
    screens: {
      sm: "576px",
